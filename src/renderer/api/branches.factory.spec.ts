...
const branch = { sessionId: 'session-0006', worktreePath: '/repo.worktrees/session-0006', branch: 'spec/0006-specify-vertical', label: 'Specify vertical', restoredStates, restoredStepCommits };
...
describe('parseRendererBranchSessions', () => {
  ...
  it('accepts a detached (not-yet-named) worktree with branch null', () => {
    const detached = { sessions: [{ sessionId: 'session-detached', worktreePath: '/repo.worktrees/session-detached', branch: null, label: 'session-detached', restoredStates, restoredStepCommits: {} }] };
