...
- **FR-014**: System MUST provide session operations for creating a session, prompting with streamed updates, setting model, setting mode, listing sessions, and loading a session.
